...
General expectations for folks contributing to the platform.
...
The full coding standard that we strive to use is available [here](https://github.com/inaka/erlang_guidelines).
...
* Ticket `KAZOO-0001` is a bug found affecting v4.4. You wish to fix the bug
  1. Create a branch off the 4.4 branch: `git checkout -b KAZOO-0001 4.4`
  2. Make the appropriate change(s) and commit: `git commit -m "KAZOO-0001: fixed X to do Y"`
  3. Push `KAZOO-0001` to your Github repo and issue a PR against openkazoo/kazoo's 4.4 branch
  4. Create appropriate pull requests for any version branches greater than your target. If 4.5 and 4.6 exist, create separate PRs for 4.5, 4.6 as well.
