...
next_valid_datetime_cron_test_() ->
    ...
    [?_assertEqual({{2013, 1, 1}, {0, 0, 0}},
                   amqp_cron_task:next_valid_datetime({'cron', {'all', 'all', 'all', 'all', 'all'}},
                                                      {{2012, 12, 31}, {23, 59, 48}}))
    ...
    ,?_assertEqual({{2013, 2, 1}, {0, 0, 0}},
                   amqp_cron_task:next_valid_datetime({'cron', {'all', 'all', 'all',
                                                                [{'list', [2]}], 'all'}},
                                                      {{2012, 12, 1}, {0, 0, 0}}))
...
time_to_wait_millis_test() ->
    ?assertEqual(60000, amqp_cron_task:time_to_wait_millis(
                          {{2012, 1, 1}, {0, 0, 0}},
                          {{2012, 1, 1}, {0, 1, 0}})).
