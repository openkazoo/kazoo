...
-spec fetch_current_status(cb_context:context(), kz_term:api_binary(), kz_term:api_boolean()) ->
    cb_context:context().
...
fetch_current_status(Context, AgentId, 'true') ->
    ...
    of
        ...
        {'ok', Resp} ->
            ...
            {_, StatusJObj} = kz_json:foldl(
                fun acdc_agent_util:find_most_recent_fold/3, {0, kz_json:new()}, Stats
            ),
